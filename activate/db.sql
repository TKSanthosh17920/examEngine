...
CREATE TABLE `iib_candidate_iway` (
  ...
  `zone_code` time NOT NULL DEFAULT '00:00:01',
  `state_code` char(5) DEFAULT NULL,
  `exam_date` date DEFAULT '1970-01-01',
  `exam_time` time DEFAULT '00:00:01',
...
(11, 'OR', 'Oriya', '0000-00-00 00:00:01', 'Y'),
...
CREATE TABLE `iib_ta_iway` (
  ...
  `exam_time` time NOT NULL DEFAULT '00:00:01'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member_rough_sheet` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01' ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `biometric_report_api` (
  ...
  `date_updated` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `candidate_seat_management` (
  ...
  `date_created` datetime NOT NULL DEFAULT '1970-01-01 00:00:01',
  `date_updated` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01' ON UPDATE CURRENT_TIMESTAMP,
  `exam_date` datetime NOT NULL DEFAULT '1970-01-01 00:00:01',
...
CREATE TABLE `biometric_changelog` (
 ...
 CREATE TABLE `exam_skip_biometricvalidation` (
  ...
  `exam_date` date NOT NULL DEFAULT '1970-01-01',
  `exam_slot_time` time NOT NULL DEFAULT '00:00:01',
  `skip_mode` tinyint(4) NOT NULL DEFAULT '0',
  `membership_no` char(20) NOT NULL DEFAULT '',
  `dateaddedon` datetime NOT NULL DEFAULT '1970-01-01 00:00:01',
  `date_updated` datetime DEFAULT '1970-01-01 00:00:01',
